...
제품 요구를 API·데이터·실시간 통신·비동기 처리의 경계로 바꾸고 배포·운영까지 연결합니다.

Node.js / NestJS 제품 백엔드 실무 2년 2개월을 기반으로 Java / Spring 역량을 확장하고 있습니다.
...
- **주식회사 하이** — 백엔드 개발자, 프리랜서에서 정규직 전환 (2023.11.20–2024.09.27)
  - JSONB 결과의 조회 시점 점진적 전환, ML 호출 비동기화, Echo middleware 기반 locale 정규화와 교차 서비스 결제 계약을 구현했습니다.
...
- [Java / Spring Concurrency Lab](https://github.com/whoisyourbias/playground/tree/81f93eb1199f384fd77bbae1477045202302a21c) — 70개 부하 케이스·274,999 요청·정합성 위반 0의 공개 재현 실험
- [Experiment Report · 81f93eb](https://github.com/whoisyourbias/playground/blob/81f93eb1199f384fd77bbae1477045202302a21c/docs/direct-db-experiment.md) — 500 RPS 중앙값 HTTP p95 25.0% 차이와 핵심 DB query 10.9배 차이의 조건·원시 결과
